...
export JANUSGRAPH_SERVER_LOCAL_DOCKER_REMOTE_DYNAMODB_YAML=${JANUSGRAPH_GREMLIN_SERVER_CONF}/gremlin-server-local-docker-remote-dynamo.yaml
...
cp ${JANUSGRAPH_DYNAMODB_TEST_RESOURCES}/gremlin-server-local-docker-remote-dynamo.yaml ${JANUSGRAPH_SERVER_LOCAL_DOCKER_REMOTE_DYNAMODB_YAML}
